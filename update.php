...
// Processing POST data for updating records
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Product_id']) && isset($_POST['Product_type']) && isset($_POST['Product_price'])) {
    $Product_id = $_POST['Product_id']; // Retrieving Product ID from the POST data
    ...
    $sql = "UPDATE products SET Product_type='$Product_type', Product_price='$Product_price' WHERE Product_id = $Product_id"; // SQL query to update record
...
<form method="post" action="">
    <input type="number" name="Product_id" placeholder="Product ID to update"> <!-- Input field for entering Product ID to update -->
    ...
    <input type="submit" value="Update"> <!-- Submit button to trigger the form submission -->
</form>
